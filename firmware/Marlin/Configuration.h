...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 138.78
  #define DEFAULT_bedKi 8.07
  #define DEFAULT_bedKd 596.84
...
#define DEFAULT_MAX_ACCELERATION      { 500, 1500, 500, 10000 }
...
#define Z_HOMING_HEIGHT 16  // (in mm) Minimal z height before homing (G28) for Z clearance above the bed, clamps, ...
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { 0, 200, (Z_MIN_POS)+12}
  #define NOZZLE_CLEAN_END_POINT   {0, 170, (Z_MIN_POS)+12}
